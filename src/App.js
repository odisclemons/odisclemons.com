            ...
            <Col lg={3} md={6} sm={12} className="jtCol vCenter jtCol0">
              ...
              >
                <div className="portfolioInfo" style={{ justifyContent: 'space-evenly' }}>
                  <a href="https://www.linkedin.com/in/odisclemons" target="_blank" rel="noopener noreferrer"><div className="myLinks">
                  ...
                  <a href="https://github.com/odisclemons" target="_blank" rel="noopener noreferrer"><div className="myLinks">
